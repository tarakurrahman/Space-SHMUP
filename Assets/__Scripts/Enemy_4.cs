...
/// <summary>
/// Enemy_4 will start offscreen and then pick a random point on screen to move to. Once it has arrived, it will pick another random point and continue until the player has shot it down.
/// </summary>
